	...
	<section class="bg0 p-t-23 p-b-130">
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<c:if test="${not empty productTypeAll}">
						<c:forEach items="${productTypeAll}" var="pt">
							<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".${pt.product_filter}">
			...
			<div class="row isotope-grid">
				...
				<c:forEach items="${productPage}" var="pa">
			...
			<div class="flex-c-m flex-w w-full p-t-38">
				<c:forEach begin="1" end="${Pagecount}" step="1" var="i">
					<a href="home-03.html?page=${i }" class="flex-c-m how-pagination1 trans-04 m-all-7 ">
						${i }
					</a>
				</c:forEach>
			</div>
